...
/** @constructor */
function $c_Lautocomplete_webapp_DOM$InputBox() {
  $c_O.call(this);
  this.wordUseHist$1 = null;
  this.pT$1 = null;
  this.i$1 = null;
  this.u$1 = null;
  this.container$1 = null;
  this.debouncer$1 = null
}
$c_Lautocomplete_webapp_DOM$InputBox.prototype = new $h_O();
$c_Lautocomplete_webapp_DOM$InputBox.prototype.constructor = $c_Lautocomplete_webapp_DOM$InputBox;
/** @constructor */
function $h_Lautocomplete_webapp_DOM$InputBox() {
  /*<skip>*/
}
$h_Lautocomplete_webapp_DOM$InputBox.prototype = $c_Lautocomplete_webapp_DOM$InputBox.prototype;
$c_Lautocomplete_webapp_DOM$InputBox.prototype.init___ = (function() {
  ...
  this.container$1 = this$6.div__Lscalatags_JsDom$TypedTag().render__Lorg_scalajs_dom_raw_Element();
  this.debouncer$1 = this.getDebouncer__F0__F0(new $c_sjsr_AnonFunction0().init___sjs_js_Function0((function($this) {
    return (function() {
      $this.onKeyUp__V()
    })
  })(this)));
  ...
  var jsx$5 = this$7.div__Lscalatags_JsDom$TypedTag();
  var this$8 = $m_Lscalatags_JsDom$all$();
  var jsx$4 = this$8.h1__Lscalatags_JsDom$TypedTag().apply__sc_Seq__Lscalatags_JsDom$TypedTag(new $c_sjs_js_WrappedArray().init___sjs_js_Array([($m_Lscalatags_JsDom$all$(), new $c_Lscalatags_JsDom$StringFrag().init___T("Trie Autocomplete"))]));
  var this$10 = $m_Lscalatags_JsDom$all$();
  var jsx$3 = this$10.div__Lscalatags_JsDom$TypedTag();
  var this$11 = $m_Lscalatags_JsDom$all$();
  var e = this.i$1;
  var jsx$2 = jsx$3.apply__sc_Seq__Lscalatags_JsDom$TypedTag(new $c_sjs_js_WrappedArray().init___sjs_js_Array([new $c_Lscalatags_LowPriorityImplicits$bindNode().init___Lscalatags_LowPriorityImplicits__Lorg_scalajs_dom_raw_Node(this$11, e)]));
  var this$12 = $m_Lscalatags_JsDom$all$();
  var e$1 = this.u$1;
  var jsx$1 = jsx$6.appendChild(jsx$5.apply__sc_Seq__Lscalatags_JsDom$TypedTag(new $c_sjs_js_WrappedArray().init___sjs_js_Array([jsx$4, jsx$2, new $c_Lscalatags_LowPriorityImplicits$bindNode().init___Lscalatags_LowPriorityImplicits__Lorg_scalajs_dom_raw_Node(this$12, e$1)])).render__Lorg_scalajs_dom_raw_Element());
  jsx$7.appendChild(jsx$1);
  this.i$1.onkeyup = (function(arg$outer) {
    return (function(arg1$2) {
      var this$13 = arg$outer.debouncer$1;
      this$13.apply__O()
    })
  })(this);
  return this
});
$c_Lautocomplete_webapp_DOM$InputBox.prototype.addWordToHist__T__V = (function(word) {
  var jsx$1 = this.wordUseHist$1;
  var y = ((1 + $uI(this.wordUseHist$1.apply__O__O(word))) | 0);
  this.wordUseHist$1 = jsx$1.$$plus__T2__sci_Map(new $c_T2().init___O__O(word, y))
});
$c_Lautocomplete_webapp_DOM$InputBox.prototype.getWords__T__sci_List = (function(content) {
  var xs = $m_sjsr_RuntimeString$().split__T__T__I__AT(content, " ", 0);
...
$c_Lautocomplete_webapp_DOM$InputBox.prototype.onKeyUp__V = (function() {
  var output = $as_T(this.i$1.value);
  var lastWord = this.getLastWord__T__T(output);
  this.addWordToHist__T__V(lastWord);
  if ((output !== "")) {
    var this$2 = new $c_sci_StringOps().init___T(lastWord);
    var this$3 = $m_sci_List$();
    var cbf = this$3.ReusableCBFInstance$2;
    var chrs = $as_sci_List($f_sc_TraversableLike__to__scg_CanBuildFrom__O(this$2, cbf));
    this.pT$1.addWord__sci_List__T__sci_List(chrs, lastWord);
    var LIs = this.getRenderedMatches__sci_List__sci_List(chrs);
    this.appendLIElements__sci_List__Lorg_scalajs_dom_raw_HTMLUListElement(LIs)
  } else {
    this.removeAllLiElements__V()
  }
});
$c_Lautocomplete_webapp_DOM$InputBox.prototype.getRenderedMatches__sci_List__sci_List = (function(lastWord) {
  var matches = this.pT$1.findMatches__sci_List__sci_List__sci_List(lastWord, $m_sci_Nil$());
  var this$5 = this.getPrioritizedMatches__sci_List__sci_List(matches);
  var f = (function($this) {
    return (function(m$2) {
      var m = $as_T(m$2);
      var this$2 = $m_Lscalatags_JsDom$all$();
      return this$2.li__Lscalatags_JsDom$TypedTag().apply__sc_Seq__Lscalatags_JsDom$TypedTag(new $c_sjs_js_WrappedArray().init___sjs_js_Array([($m_Lscalatags_JsDom$all$(), new $c_Lscalatags_JsDom$StringFrag().init___T(m))])).render__Lorg_scalajs_dom_raw_Element()
    })
  })(this);
...
$c_Lautocomplete_webapp_DOM$InputBox.prototype.getPrioritizedMatches__sci_List__sci_List = (function(matches) {
  var lt = new $c_sjsr_AnonFunction2().init___sjs_js_Function2((function($this) {
    return (function(x$1$2, x$2$2) {
      var x$1 = $as_T(x$1$2);
      var x$2 = $as_T(x$2$2);
      return ($uI($this.wordUseHist$1.apply__O__O(x$1)) > $uI($this.wordUseHist$1.apply__O__O(x$2)))
    })
  })(this));
  return $as_sci_List($f_sc_SeqLike__sortWith__F2__O(matches, lt))
});
$c_Lautocomplete_webapp_DOM$InputBox.prototype.appendLIElements__sci_List__Lorg_scalajs_dom_raw_HTMLUListElement = (function(liElements) {
  this.removeAllLiElements__V();
  var these = liElements;
  while ((!these.isEmpty__Z())) {
    var arg1 = these.head__O();
    this.u$1.appendChild(arg1);
    var this$1 = these;
...
$c_Lautocomplete_webapp_DOM$InputBox.prototype.getDebouncer__F0__F0 = (function(F) {
  var timeout = new $c_sr_IntRef().init___I(0);
  return new $c_sjsr_AnonFunction0().init___sjs_js_Function0((function($this, F$1, timeout$1) {
    return (function() {
      $this.debounce$1__p1__F0__sr_IntRef__V(F$1, timeout$1)
    })
  })(this, F, timeout))
});
var $d_Lautocomplete_webapp_DOM$InputBox = new $TypeData().initClass({
  Lautocomplete_webapp_DOM$InputBox: 0
}, false, "autocomplete.webapp.DOM$InputBox", {
  Lautocomplete_webapp_DOM$InputBox: 1,
  O: 1
});
$c_Lautocomplete_webapp_DOM$InputBox.prototype.$classData = $d_Lautocomplete_webapp_DOM$InputBox;
/** @constructor */
...
/** @constructor */
function $c_Lautocomplete_webapp_Autocomplete$() {
  $c_O.call(this)
}
$c_Lautocomplete_webapp_Autocomplete$.prototype = new $h_O();
$c_Lautocomplete_webapp_Autocomplete$.prototype.constructor = $c_Lautocomplete_webapp_Autocomplete$;
/** @constructor */
function $h_Lautocomplete_webapp_Autocomplete$() {
  /*<skip>*/
}
$h_Lautocomplete_webapp_Autocomplete$.prototype = $c_Lautocomplete_webapp_Autocomplete$.prototype;
$c_Lautocomplete_webapp_Autocomplete$.prototype.init___ = (function() {
  return this
});
$c_Lautocomplete_webapp_Autocomplete$.prototype.$$js$exported$meth$main__O = (function() {
  new $c_Lautocomplete_webapp_DOM$InputBox().init___()
});
$c_Lautocomplete_webapp_Autocomplete$.prototype.main = (function() {
  return this.$$js$exported$meth$main__O()
});
var $d_Lautocomplete_webapp_Autocomplete$ = new $TypeData().initClass({
  Lautocomplete_webapp_Autocomplete$: 0
}, false, "autocomplete.webapp.Autocomplete$", {
  Lautocomplete_webapp_Autocomplete$: 1,
  O: 1,
  sjs_js_JSApp: 1
});
$c_Lautocomplete_webapp_Autocomplete$.prototype.$classData = $d_Lautocomplete_webapp_Autocomplete$;
var $n_Lautocomplete_webapp_Autocomplete$ = (void 0);
function $m_Lautocomplete_webapp_Autocomplete$() {
  if ((!$n_Lautocomplete_webapp_Autocomplete$)) {
    $n_Lautocomplete_webapp_Autocomplete$ = new $c_Lautocomplete_webapp_Autocomplete$().init___()
  };
  return $n_Lautocomplete_webapp_Autocomplete$
}
$e.autocomplete = ($e.autocomplete || {});
$e.autocomplete.webapp = ($e.autocomplete.webapp || {});
$e.autocomplete.webapp.Autocomplete = $m_Lautocomplete_webapp_Autocomplete$;
...
$c_sjsr_RuntimeLong.prototype.$classData = $d_sjsr_RuntimeLong;
/** @constructor */
function $c_Lmain_scala_autocomplete_webapp_PrefixTrie() {
  $c_O.call(this);
  this.chr$1 = null;
  this.letters$1 = null;
  this.main$scala$autocomplete$webapp$PrefixTrie$$word$1 = null;
  this.children$1 = null;
  this.fullWord$1 = null
}
$c_Lmain_scala_autocomplete_webapp_PrefixTrie.prototype = new $h_O();
$c_Lmain_scala_autocomplete_webapp_PrefixTrie.prototype.constructor = $c_Lmain_scala_autocomplete_webapp_PrefixTrie;
/** @constructor */
function $h_Lmain_scala_autocomplete_webapp_PrefixTrie() {
  /*<skip>*/
}
$h_Lmain_scala_autocomplete_webapp_PrefixTrie.prototype = $c_Lmain_scala_autocomplete_webapp_PrefixTrie.prototype;
$c_Lmain_scala_autocomplete_webapp_PrefixTrie.prototype.setWord__p1__T__Z__V = (function(newWord, shouldSet) {
  if (shouldSet) {
    this.fullWord$1 = newWord
  }
});
$c_Lmain_scala_autocomplete_webapp_PrefixTrie.prototype.productPrefix__T = (function() {
  return "PrefixTrie"
});
$c_Lmain_scala_autocomplete_webapp_PrefixTrie.prototype.getMatchingChild__p1__C__s_Option = (function(chr) {
  var nonLocalReturnKey1 = new $c_O().init___();
  try {
    var this$1 = this.children$1;
    var these = this$1;
    while ((!these.isEmpty__Z())) {
      var arg1 = these.head__O();
      var child = $as_Lmain_scala_autocomplete_webapp_PrefixTrie(arg1);
      var jsx$1 = $m_sr_BoxesRunTime$();
      var this$2 = child.chr$1;
      if (jsx$1.equals__O__O__Z((this$2.isEmpty__Z() ? "" : this$2.get__O()), new $c_jl_Character().init___C(chr))) {
        throw new $c_sr_NonLocalReturnControl().init___O__O(nonLocalReturnKey1, new $c_s_Some().init___O(child))
      };
      var this$5 = these;
...
$c_Lmain_scala_autocomplete_webapp_PrefixTrie.prototype.productArity__I = (function() {
  return 4
});
$c_Lmain_scala_autocomplete_webapp_PrefixTrie.prototype.equals__O__Z = (function(x$1) {
  if ((this === x$1)) {
    return true
  } else if ($is_Lmain_scala_autocomplete_webapp_PrefixTrie(x$1)) {
    var PrefixTrie$1 = $as_Lmain_scala_autocomplete_webapp_PrefixTrie(x$1);
    var x = this.chr$1;
    var x$2 = PrefixTrie$1.chr$1;
    if (((x === null) ? (x$2 === null) : x.equals__O__Z(x$2))) {
      var x$3 = this.letters$1;
      var x$4 = PrefixTrie$1.letters$1;
      var jsx$1 = ((x$3 === null) ? (x$4 === null) : x$3.equals__O__Z(x$4))
    } else {
      var jsx$1 = false
    };
    if ((jsx$1 && (this.main$scala$autocomplete$webapp$PrefixTrie$$word$1 === PrefixTrie$1.main$scala$autocomplete$webapp$PrefixTrie$$word$1))) {
      var x$5 = this.children$1;
      var x$6 = PrefixTrie$1.children$1;
...
$c_Lmain_scala_autocomplete_webapp_PrefixTrie.prototype.productElement__I__O = (function(x$1) {
  switch (x$1) {
    case 0: {
      return this.chr$1;
      break
    ...
    case 2: {
      return this.main$scala$autocomplete$webapp$PrefixTrie$$word$1;
      break
    }
    case 3: {
...
$c_Lmain_scala_autocomplete_webapp_PrefixTrie.prototype.toString__T = (function() {
  return $m_sr_ScalaRunTime$().$$undtoString__s_Product__T(this)
});
$c_Lmain_scala_autocomplete_webapp_PrefixTrie.prototype.addChild__p1__sci_List__T__sci_List = (function(letters, word) {
  if ($is_sci_$colon$colon(letters)) {
    var x2 = $as_sci_$colon$colon(letters);
    var c = x2.head$5;
    if ((c === null)) {
      var head = 0
    } else {
      var this$2 = $as_jl_Character(c);
      var head = this$2.value$1
    };
    var tail = x2.tl$5;
    var newNode = new $c_Lmain_scala_autocomplete_webapp_PrefixTrie().init___s_Option__sci_List__T__sci_List($m_s_Option$().apply__O__s_Option(new $c_jl_Character().init___C(head)), tail, word, $m_sci_Nil$());
    var this$6 = this.children$1;
    this.children$1 = new $c_sci_$colon$colon().init___O__sci_List(newNode, this$6);
    return this.children$1
  } else {
    throw new $c_s_MatchError().init___O(letters)
  }
});
$c_Lmain_scala_autocomplete_webapp_PrefixTrie.prototype.getAllPossibilities__p1__sci_List = (function() {
  var this$2 = this.children$1;
  var f = (function($this) {
    return (function(x$4$2) {
      var x$4 = $as_Lmain_scala_autocomplete_webapp_PrefixTrie(x$4$2);
      return x$4.findMatches__sci_List__sci_List__sci_List($m_sci_Nil$(), $m_sci_Nil$())
    })
  })(this);
  var this$1 = $m_sci_List$();
...
$c_Lmain_scala_autocomplete_webapp_PrefixTrie.prototype.init___s_Option__sci_List__T__sci_List = (function(chr, letters, word, children) {
  this.chr$1 = chr;
  this.letters$1 = letters;
  this.main$scala$autocomplete$webapp$PrefixTrie$$word$1 = word;
  this.children$1 = children;
  this.children$1 = this.addWord__sci_List__T__sci_List(letters, word);
  this.fullWord$1 = "";
  this.setWord__p1__T__Z__V(word, this.children$1.isEmpty__Z());
  return this
});
$c_Lmain_scala_autocomplete_webapp_PrefixTrie.prototype.addWord__sci_List__T__sci_List = (function(letters, word) {
  var nonLocalReturnKey2 = new $c_O().init___();
  try {
    var x = $m_sci_Nil$();
    if (x.equals__O__Z(letters)) {
      this.setWord__p1__T__Z__V(word, true);
      return $m_sci_Nil$()
    } else if ($is_sci_$colon$colon(letters)) {
      var x2 = $as_sci_$colon$colon(letters);
      var c = x2.head$5;
      if ((c === null)) {
        var head = 0
      ...
      var tail = x2.tl$5;
      var this$3 = this.children$1;
      var these = this$3;
      while ((!these.isEmpty__Z())) {
        var arg1 = these.head__O();
        var child = $as_Lmain_scala_autocomplete_webapp_PrefixTrie(arg1);
        var jsx$1 = $m_sr_BoxesRunTime$();
        var this$4 = child.chr$1;
        if (jsx$1.equals__O__O__Z((this$4.isEmpty__Z() ? "" : this$4.get__O()), new $c_jl_Character().init___C(head))) {
          throw new $c_sr_NonLocalReturnControl().init___O__O(nonLocalReturnKey2, child.addWord__sci_List__T__sci_List(tail, word))
        };
        var this$7 = these;
        these = this$7.tail__sci_List()
      };
      return this.addChild__p1__sci_List__T__sci_List(letters, word)
    } else {
      throw new $c_s_MatchError().init___O(letters)
    }
  } catch (e) {
...
$c_Lmain_scala_autocomplete_webapp_PrefixTrie.prototype.hashCode__I = (function() {
  var this$2 = $m_s_util_hashing_MurmurHash3$();
  return this$2.productHash__s_Product__I__I(this, (-889275714))
});
$c_Lmain_scala_autocomplete_webapp_PrefixTrie.prototype.findMatches__sci_List__sci_List__sci_List = (function(letters, found) {
  var x = $m_sci_Nil$();
  if (x.equals__O__Z(letters)) {
    var updatedFound = this.accumulateWord__p1__sci_List__sci_List(found);
    var jsx$1 = this.getAllPossibilities__p1__sci_List();
    var this$1 = $m_sci_List$();
    return $as_sci_List(updatedFound.$$plus$plus__sc_GenTraversableOnce__scg_CanBuildFrom__O(jsx$1, this$1.ReusableCBFInstance$2))
  } else if ($is_sci_$colon$colon(letters)) {
    var x2 = $as_sci_$colon$colon(letters);
    var c = x2.head$5;
    if ((c === null)) {
      ...
      var this$3 = $as_jl_Character(c);
      var head = this$3.value$1
    };
    var tail = x2.tl$5;
    var matchingChild = this.getMatchingChild__p1__C__s_Option(head);
    if (matchingChild.isEmpty__Z()) {
      var this$4 = $m_s_None$()
    } else {
      var arg1 = matchingChild.get__O();
      var x$3 = $as_Lmain_scala_autocomplete_webapp_PrefixTrie(arg1);
      var this$4 = new $c_s_Some().init___O(x$3.findMatches__sci_List__sci_List__sci_List(tail, found))
    };
    return $as_sci_List((this$4.isEmpty__Z() ? found : this$4.get__O()))
  } else {
    throw new $c_s_MatchError().init___O(letters)
  }
});
$c_Lmain_scala_autocomplete_webapp_PrefixTrie.prototype.productIterator__sc_Iterator = (function() {
  return new $c_sr_ScalaRunTime$$anon$1().init___s_Product(this)
});
$c_Lmain_scala_autocomplete_webapp_PrefixTrie.prototype.accumulateWord__p1__sci_List__sci_List = (function(found) {
  var foundWord = this.fullWord$1;
  var foundWords = found;
  if ((foundWord !== "")) {
    foundWords = new $c_sci_$colon$colon().init___O__sci_List(foundWord, found)
  };
  return foundWords
});
function $is_Lmain_scala_autocomplete_webapp_PrefixTrie(obj) {
  return (!(!((obj && obj.$classData) && obj.$classData.ancestors.Lmain_scala_autocomplete_webapp_PrefixTrie)))
}
function $as_Lmain_scala_autocomplete_webapp_PrefixTrie(obj) {
  return (($is_Lmain_scala_autocomplete_webapp_PrefixTrie(obj) || (obj === null)) ? obj : $throwClassCastException(obj, "main.scala.autocomplete.webapp.PrefixTrie"))
}
function $isArrayOf_Lmain_scala_autocomplete_webapp_PrefixTrie(obj, depth) {
  return (!(!(((obj && obj.$classData) && (obj.$classData.arrayDepth === depth)) && obj.$classData.arrayBase.ancestors.Lmain_scala_autocomplete_webapp_PrefixTrie)))
}
function $asArrayOf_Lmain_scala_autocomplete_webapp_PrefixTrie(obj, depth) {
  return (($isArrayOf_Lmain_scala_autocomplete_webapp_PrefixTrie(obj, depth) || (obj === null)) ? obj : $throwArrayCastException(obj, "Lmain.scala.autocomplete.webapp.PrefixTrie;", depth))
}
var $d_Lmain_scala_autocomplete_webapp_PrefixTrie = new $TypeData().initClass({
  Lmain_scala_autocomplete_webapp_PrefixTrie: 0
}, false, "main.scala.autocomplete.webapp.PrefixTrie", {
  Lmain_scala_autocomplete_webapp_PrefixTrie: 1,
  O: 1,
  s_Product: 1,
  s_Equals: 1,
  s_Serializable: 1,
...
$c_Lmain_scala_autocomplete_webapp_PrefixTrie.prototype.$classData = $d_Lmain_scala_autocomplete_webapp_PrefixTrie;
/** @constructor */
...
$c_s_math_Ordering$$anon$9.prototype.init___F2 = (function(cmp$2) {
  this.cmp$2$1 = cmp$2;
  return this
});
$c_s_math_Ordering$$anon$9.prototype.compare__O__O__I = (function(x, y) {
  return ($uZ(this.cmp$2$1.apply__O__O__O(x, y)) ? (-1) : ($uZ(this.cmp$2$1.apply__O__O__O(y, x)) ? 1 : 0))
});
$c_s_math_Ordering$$anon$9.prototype.lteq__O__O__Z = (function(x, y) {
  return (!$uZ(this.cmp$2$1.apply__O__O__O(y, x)))
});
...
function $f_sc_SeqLike__sortWith__F2__O($thiz, lt) {
  var ord = new $c_s_math_Ordering$$anon$9().init___F2(lt);
  return $f_sc_SeqLike__sorted__s_math_Ordering__O($thiz, ord)
}
...
function $f_sci_Map__withDefaultValue__O__sci_Map($thiz, d) {
  return new $c_sci_Map$WithDefault().init___sci_Map__F1($thiz, new $c_sjsr_AnonFunction1().init___sjs_js_Function1((function($this, d$1) {
    return (function(x$2) {
      return d$1
    })
  })($thiz, d)))
...
$c_sci_AbstractMap.prototype.withDefaultValue__O__sci_Map = (function(d) {
  return $f_sci_Map__withDefaultValue__O__sci_Map(this, d)
});
...
$c_sci_Map$WithDefault.prototype.withDefaultValue__O__sci_Map = (function(d) {
  return new $c_sci_Map$WithDefault().init___sci_Map__F1(this.underlying$5, new $c_sjsr_AnonFunction1().init___sjs_js_Function1((function($this, d$1) {
    return (function(x$2) {
      return d$1
    })
  })(this, d)))
...
//# sourceMappingURL=trie-autocomplete-fastopt.js.map
